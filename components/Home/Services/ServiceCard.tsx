...
const ServiceCard = ({ icon, image }: Props) => {
  return (
    <div className="rounded-lg group overflow-hidden bg-white">
      ...
      <div className="p-4">
        <div
          className="w-22 h-22 -mt-14 relative group-hover:bg-black transition-all 
        duration-200 z-10 ml-auto rounded-lg flex items-center justify-center flex-col bg-[#b69974]"
        >
          {/* icon image */}
        ...
        <div className="w-16 mt-6 h-px bg-gray-700"></div>
          ...
          <p className="text-gray-800 mb-4 mt-2 font-semibold">
            Work From Home
          </p>
      </div>
    </div>
